...
image_story4 = ImageTk.PhotoImage(file=r"C:\CSP1123\Project\storyline 4 background.png")
...
button_image= ImageTk.PhotoImage(Image.open("C:\CSP1123\Project\Jart.png"))
...
button_image= ImageTk.PhotoImage(Image.open("C:\CSP1123\Project\Peter.png"))
...
button_image= ImageTk.PhotoImage(Image.open("C:\CSP1123\Project\Ava.png"))
button=canvas.create_image(797,500, image=button_image)
canvas.tag_bind(button,"<Button-1>", show_message)

def open_Lucy_window(event):
    subprocess.Popen(["python", "Lucy.py"])
    root.destroy()

Lucy_button_image = ImageTk.PhotoImage(Image.open("C:\CSP1123\Project\Lucy.png"))
