...
hall_button_image = ImageTk.PhotoImage(Image.open("Image\Level_1\Hall_Button.png"))
...
room_button_image = ImageTk.PhotoImage(Image.open("Image\Level_1\Room_Button.png"))
