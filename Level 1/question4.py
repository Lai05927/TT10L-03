...
def handle_correct_answer():
    ...
    subprocess.Popen(['python','Level 2/Story2.py'])
    root.destroy()
...
ques_image1 = Image.open("Level 1/Level 1 image/button_nobody.png")
...
ques_image3 = Image.open("Level 1/Level 1 image/button_herself (2).png")
