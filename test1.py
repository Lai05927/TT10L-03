...
def on_option_click(option):
    ...
    elif option in ["Reynold", "Emberly", "Kiara"]:
        if option == "Alice":
            new_text = "I am Alice"
        elif option == "Bob":
...
selection_buttons_emberly = create_text_selection_buttons(canvas, ["Reynold", "Emberly", "Kiara"], 900, 350)
selection_buttons_chandra = create_text_selection_buttons(canvas, ["Alice", "Bob", "Charlie"], 900, 350)
selection_buttons_heidi = create_text_selection_buttons(canvas, ["Alice", "Bob", "Charlie"],  900, 350)
selection_buttons_reynold = create_text_selection_buttons(canvas, ["Alice", "Bob", "Charlie"],  900, 350)
selection_buttons_kiara = create_text_selection_buttons(canvas, ["Alice", "Bob", "Charlie"],  900, 350)
selection_buttons_jane = create_text_selection_buttons(canvas, ["Alice", "Bob", "Charlie"],  900, 350)
selection_buttons_mary = create_text_selection_buttons(canvas, ["Alice", "Bob", "Charlie"],  900, 350)

# Create the return button but hide it initially
return_button = create_return_button(canvas,  900, 350)
canvas.itemconfig(return_button, state='hidden')

# Create the back button but hide it initially
back_button = create_back_button(canvas, 900, 450)
canvas.itemconfig(back_button, state='hidden')
