...
answer2_count = 0
answer2_text = ""
answer2_label = canvas.create_text(600, 300, text=answer2_txt, font=("Comic Sans MS", 40, "bold"), fill="brown")


def animate_text():
    global answer2_count, answer2_text
    if answer2_count < len(answer2_txt):
